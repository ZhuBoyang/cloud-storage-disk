...
public class TableMapper {
    ...
    public String generateVideoMetadata() {
        return StrBuilder.create("CREATE TABLE `video_metadata` (")
                .append("  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,")
                .append("  `file_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '文件 id',")
                .append("  `thumbnail` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '视频缩略图地址',")
                .append("  `duration` double NOT NULL COMMENT '总时长',")
                .append("  `bitrate` varchar(20) COLLATE utf8mb4_general_ci NOT NULL COMMENT '比特率',")
                .append("  `width` smallint NOT NULL COMMENT '分辨率宽度',")
                .append("  `height` smallint NOT NULL COMMENT '分辨率高度',")
